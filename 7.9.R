...
# calculate RSS for a range of df from 3 to 15
...
plot(3:15, all.cv[-c(1, 2)], lwd = 2, type = "l", xlab = "df", ylab = "CV error")

# CV error attains minimum at df=12. We pick 12 as the optimal degrees of freedom
